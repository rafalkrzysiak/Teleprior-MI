...
for i = 1:Np
    ...
    for j = 1:Nc
        ...
        hold on; plot(SimExp(i,j).simdata.tloc(1, 1), ...
                      ...
                      'ms', 'LineWidth', 3, 'MarkerSize', 12); % -- experiment robot (human controlled robot start)
        ...
        hold on; plot(SimExp(i,j).simdata.Xs(1, tf, 1, 1), ...
                      ...
                      'kx', 'LineWidth', 3, 'MarkerSize', 12); % -- experiment robot (human controlled robot start)
        hold on; plot(SimExp(i,j).simdata.Xs(1, tf, 1, 2), ...
                      SimExp(i,j).simdata.Xs(2, tf, 1, 2), ...
                      'rx', 'LineWidth', 3, 'MarkerSize', 12); % -- autonomous robot 1 start
        hold on; plot(SimExp(i,j).simdata.Xs(1, tf, 1, 3), ...
                      SimExp(i,j).simdata.Xs(2, tf, 1, 3), ...
                      'gx', 'LineWidth', 3, 'MarkerSize', 12); % -- autonomous robot 2 start
